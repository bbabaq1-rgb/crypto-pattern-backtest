...
START_EQ = 1000.0
MAX_POS = 13     # 실거래 MAX_LIVE_POS 와 동일하게 유지 (2026-09-05 12→16 → 2026-09-18 16→13,
                 # RISK_FRAC 1.5% 상향과 한 쌍 — 총명목 상한이 13.3개에서 걸린다).
                 # 2026-09-02 연구는 12, 2026-09-05~09-18 연구는 16 으로 돌았다.
