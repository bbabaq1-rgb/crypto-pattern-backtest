...
| 워크플로 | 크론 | 관찰 구간 | 발화 |
|---|---|---|---|
| fast_scheduler | `7 * * * *` (정시 회피) | 02:07 / 03:07 / 04:07 / 05:07 | **0/4** |
| daily_scheduler | `0 */4 * * *` | 04:00 | **미발화** (05:45 기준 105분) |

4h 시대(7/02~9/01) 368건의 지연 분포에서 98분 초과는 6%(23건)라 04:00 틱이 아직
큐에 있을 가능성은 남지만, 오프셋 매시 크론 0/4 는 확정이다. 두 스케줄이 워크플로 파일
