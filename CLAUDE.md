...
## 다음 할 일
- [ ] **김치 프리미엄 사전 등록 결과 판독** (registry `kimchi_prereg_2026_09_22`) — 가족 X(횡단면 종목 선택,
      환율 소거) / 가족 T(시계열 방향, 환율 오염). DEPLOY_ON_PASS=False 라 통과해도 실거래 반영 없음 —
      승격하려면 진입 규칙으로 별도 사전 등록이 필요하고 관찰 기간(~2026-10-06)이 먼저다
