...
- [ ] **tp1_engulfing_1h $70(9/10 상향 전 $30) 강제 실행 대조 보고** — 진입 30건 또는 10-06: 실거래 승률·건당·수수료 합·포트 잔액 vs tp_1h(88.00% / −0.28%). 정지·충전은 사용자 결정
      ...
      · **4건차 (ETH 롱, 2026-09-14 21:03Z 청산) — 익절.** 진입 2542.14(9/12 14:03Z) → 체결 **2566.2475**
        ...
        · **장부 수치는 $76.71 로 찍힐 수 있다** — 그 로그가 `fill=None` 이라 엔진이 체결가 대신 봉 기준
          (배리어 정확히 +1%)으로 기록한다. 실제 체결 기준은 $76.59 — 차이 $0.12 는 미끄러짐. 다음 tp1
          진입 로그의 `cap_margin` 이 어느 쪽인지 확정한다.
        · **보유 55시간**(9/12 14:03Z → 9/14 21:03Z). tp_1h 검증 보유 중앙 17봉의 3배 — 이상은 아니나
          1포지션 캡에서는 이게 곧 기회비용이다(아래).
      · **누적 4건 4승** (tp_1h 검증 승률 88.00% 대비 표본 부족 — 판단 유보). 네 건 다 +1% 부근 체결
        (미끄러짐 0.02~0.07%p). 포트 70 → 71.63 → 73.19 → 74.90 → **약 76.59**.
      · **30건 목표는 사실상 도달 불가 — 10/06 이 실질 종료 시점**: 9/09 시작 후 5일에 4건이고, 4건차가
        혼자 55시간 동안 슬롯을 잡는 사이 **캡 스킵 10건**이 쌓였다(ARB·LINK·ETH·TAO·BTC·BICO·BTC·BCH·
        LTC·NEAR). 남은 기간을 다 써도 15~20건. 1포지션 캡(사용자 지정 `live_cap.max_open=1`)의 구조적 결과다.
