...
- [ ] **equity $533 하한 주시** (2026-09-10 갱신 — risk 1% 하향으로 $355 → $533) — 전 신호 통과
      ...
      · **2026-09-11 현재 equity $597.79 — 여유 $65** (9/10 사용자 출금 약 $133 반영, registry `fund_move_2026_09_10`).
...
- [ ] **tp1_engulfing_1h $70(9/10 상향 전 $30) 강제 실행 대조 보고** — 진입 30건 또는 10-06: 실거래 승률·건당·수수료 합·포트 잔액 vs tp_1h(88.00% / −0.28%). 정지·충전은 사용자 결정
      ...
      · 2건차 SOL 진입(12:00Z, 포트 $71.63, 명목 $214.89) — **메인 equal_lows_4h 와 같은 종목이라 registry
        `shared_symbol_oco_2026_09_11` 쟁점에 해당**(아래).
- [ ] **겹친 종목 OCO — 메인 레그에 미검증 익절이 걸린다 (2026-09-11 발견, 사용자 결정 대기)**: registry
