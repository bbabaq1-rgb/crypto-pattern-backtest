...
- [ ] **LEV_CAP 재검토** — risk 1.5% 부터는 증거금이 제약이 된다(equity $400 에서 12슬롯에 $450 필요).
      격자상 1.5%/lev3 이 증거금 스킵 109->15, Calmar 1.03->1.13. risk 1% 때의 '레버리지 무의미'
      결론은 이 위험 수준에서 더는 성립하지 않는다 — 사용자 결정 사항
