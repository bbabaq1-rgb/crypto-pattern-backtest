...
- [ ] **위험 수준(RISK_FRAC) 결정** (사용자) — 격자상 Calmar 가 평평해 통계가 답을 못 준다.
      사전 기준 통과는 0.5%(CAGR+26%/MDD-25%)뿐, 현행 1%는 +49%/-45%, 1.5%는 +69%/-61%(p10 -80%).
      레버리지 상향은 **권고 안 함**(살 게 없고 소액 계좌에선 최소주문 스킵만 늘린다)
