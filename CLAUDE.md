...
- [ ] **크론 분리** — 매시 실행하되 1d/4h 탐지는 UTC 00/04/08/12/16/20 에만(방안 A).
      그냥 매시로 바꾸면 배포된 1d/4h 패턴의 진입 분포가 검증 당시와 달라진다
- [ ] 크론 분리 후 캐스케이드 adopted_1h_patterns 등재 — **사용자 판단**
      (median 여유 +0.31%p / OOS 2/4 최소기준 / 마찰 내성 왕복 0.4%)
